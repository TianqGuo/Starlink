...
class WorldMap extends Component {
    ...
    track = data => {
        ...
        // calculate time by delta time * 60
    ...
    generateMap(land){
        ...
        // note that node() is a method of canvas
        let context = canvas.node().getContext("2d");

        const context2 = canvas2.node().getContext("2d");

        // drawing by map shape and context: projection and context
        let path = geoPath()
